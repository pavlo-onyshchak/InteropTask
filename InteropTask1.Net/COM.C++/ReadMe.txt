========================================================================
    ACTIVE TEMPLATE LIBRARY : COM.C++ Project Overview
========================================================================

AppWizard has created this COM.C++ project for you to use as the starting point for
...
COMC.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (COMC.h)
        GUID definitions                                (COMC_i.c)
        A type library                                  (COMC.tlb)
        Marshaling code                                 (COMC_p.c and dlldata.c)

COMC.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in COMC.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named COM.C++.pch and a precompiled types file named StdAfx.obj.
...
COM.C++ps.vcxproj
	...
	dlldata.c, COMC_i.c and COMC_p.c which are required
	to build the proxy/stub DLL.

COM.C++ps.vcxproj.filters
